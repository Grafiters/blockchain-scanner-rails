...
describe API::V2::Management::Transfers, type: :request do
  ...
  describe 'create operation' do
    ...
    context 'referral program story' do
      ...
      let(:referrer1) { create(:member, :account) }
      let(:referrer2) { create(:member, :account) }
      let(:referrer3) { create(:member, :account) }
    ...
    context 'token distribution story' do
      ...
      let(:member1) { create(:member, :account) }
      let(:member2) { create(:member, :account) }
