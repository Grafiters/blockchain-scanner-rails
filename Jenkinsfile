pipeline {
    ...
    environment {
        ...
        CONTAINER_NAMES = 'oeypay_process_block_1, oeypay_deposit_1, oeypay_blockchain_1_1, oeypay_blockchain_2_1'
        CONTAINER_TO_RESTARTS = 'process_block, deposit, blockchain_1, blockchain_2'
